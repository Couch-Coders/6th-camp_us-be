...
public class QReview extends EntityPathBase<Review> {
    ...
    public final ListPath<ReviewLike, couch.camping.domain.reviewlike.entity.QReviewLike> reviewLikeList = this.<ReviewLike, couch.camping.domain.reviewlike.entity.QReviewLike>createList("reviewLikeList", ReviewLike.class, couch.camping.domain.reviewlike.entity.QReviewLike.class, PathInits.DIRECT2);
