...
import couch.camping.domain.camp.repository.camp_like.CampLikeRepository;
import couch.camping.domain.comment.service.CommentService;
import couch.camping.domain.member.entity.Member;
import couch.camping.domain.member.service.MemberRegisterDto;
...
public class MemberController {
    ...
    public ResponseEntity<MemberRegisterResponseDto> registerLocalMember(@RequestBody @Valid MemberSaveRequestDto memberSaveRequestDto) {
        MemberRegisterDto memberRegisterDto = new MemberRegisterDto(memberSaveRequestDto.getUid(), memberSaveRequestDto.getName(),
